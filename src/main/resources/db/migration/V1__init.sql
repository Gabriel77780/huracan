...
CREATE TABLE sale (
                       ...
                       CONSTRAINT fk_sales_user FOREIGN KEY (system_user_id) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE purchase (
                           ...
                           CONSTRAINT fk_purchases_user FOREIGN KEY (system_user_id) REFERENCES users(id) ON DELETE CASCADE
);
